...
//        dislaying error using snackbar element
        Snackbar showError = Snackbar.make(context,errorText,Snackbar.LENGTH_SHORT);
...
//          dislaying message using snackbar element
        Snackbar showMsg = Snackbar.make(context,msgText,Snackbar.LENGTH_SHORT);
...
//Creating function fetchFromDatabse to fetch the messages from database if present to load all the messages on the initial loading of the app
...
//                    Extracting json array inside the received json
